  ...
  "@graph": [
    {
      ...
      jobTitle: brand.role,
      description:
        "Senior Software Engineer and AI Engineer with 5+ years building production systems: multi-tenant SaaS platforms, high-throughput REST APIs, AWS cloud architecture, and applied AI including RAG pipelines and real-time voice agents.",
